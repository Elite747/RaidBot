...
public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PlayerRole>().HasData([
            new PlayerRole { Id = 1, Name = "Tank", Icon = "<:tank:945067186421116958>", SearchTerms = "tank;t" },
            new PlayerRole { Id = 2, Name = "Healer", Icon = "<:healer:945067186542772244>", SearchTerms = "healer;heals;heal;h" },
